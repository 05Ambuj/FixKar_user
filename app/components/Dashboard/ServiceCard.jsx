...
import ServiceDetailsModal from './ServiceDetailsModal'; // Import the ServiceDetailsModal
...
const ServiceCard = ({
  ...
  const handleRequestService = (selectedService) => {
    console.log("Service requested for:", {
      selectedDate,
      selectedTime,
      name,
      ...
      <TouchableOpacity onPress={() => toggleExpandService(service._id)}>
        <View style={styles.recommendedCardContent}>
          ...
          <MaterialCommunityIcons
            name={expandedServiceId === service._id ? "chevron-up" : "chevron-down"}
            size={24}
            color="#A0A0A0"
        ...
        <Collapsible collapsed={expandedServiceId !== service._id}>
          <Text style={styles.recommendedDescription}>{service.description}</Text>
            ...
            {step === 3 && (
              <>
                ...
                <View style={styles.modalButtonContainer}>
                  <Button title="Send Request" onPress={() => handleRequestService(service)} />
